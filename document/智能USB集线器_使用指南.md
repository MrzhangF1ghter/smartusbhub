...
| 项目         | 说明                                                         |
| ------------ | ------------------------------------------------------------ |
| USB规格      | USB2.0高速480Mbps、全速12Mbps和低速1.5Mbps，向下兼容USB1.1协议规范 |
| 供电接口     | Type-C；可通过此接口为下行设备供电                           |
| 数据上行接口 | Type-C；可通过此接口为下行设备供电                           |
| USB下行接口  | 4个 USB-A型接口                                              |
| 接口功率     | 每路5V 4A Max                                                |
| 接口保护     | 总输入过压保护、每路输入过流保护、ESD防护                    |
| 指令控制     | 可通过简易指令控制                                           |
